...
//////////////////////////////////////////////////////////////////////////
void OnlineMCLPBoost::RecordModel(FILE *fp)
{
	printf("*****OnlineMCLPBoost::RecordModel*****\n");
	Booster::RecordModel(fp);
	fprintf(fp, "%lf\t%lf", m_nuD, m_nuP);
	fprintf(fp, "\n");
}

void OnlineMCLPBoost::LoadModel(FILE *fp)
{
	printf("*****OnlineMCLPBoost::LoadModel*****\n");
	Booster::LoadModel(fp);
	fscanf(fp, "%lf%lf", &m_nuD, &m_nuP);
}
//////////////////////////////////////////////////////////////////////////