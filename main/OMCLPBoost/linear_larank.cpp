...
//////////////////////////////////////////////////////////////////////////
void LinearLaRank::RecordModel(FILE *fp)
{
	printf("*****LinearLaRank::RecordModel*****\n");
	m_svm->RecordModel(fp);
	fprintf(fp, "%d\n", m_sampleCount);
}

void LinearLaRank::LoadModel(FILE *fp)
{
	printf("*****LinearLaRank::LoadModel*****\n");
	m_svm->LoadModel(fp);
	fscanf(fp, "%d", &m_sampleCount);
}
//////////////////////////////////////////////////////////////////////////