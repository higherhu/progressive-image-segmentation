...
public:
	...
	flowtype maxflow(bool reuse_trees = false, GBlock<node_id>* changed_list = NULL);
...
public:
	...
	//		GBlock<G::node_id>* changed_list = new GBlock<G::node_id>(128);
	//
	//		... // add nodes and edges
	//
